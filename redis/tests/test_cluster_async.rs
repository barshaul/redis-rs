...
fn get_node_view_index(num_of_view: usize, ports: &Vec<u16>, called_port: u16) -> usize {
...
fn test_cluster_refresh_topology_after_moved_assert_get_succeed_and_expected_retries(
    ...
    runtime.block_on(async move {
        ...
        for _ in 0..100 {
            refreshed_calls = refresh_calls.clone().load(atomic::Ordering::Relaxed);
